...
export function Routes() {
  ...
  // useEffect(() => {
  //   if (redirectToHome) {
  //     // Se redirectToLogin for true, redirecione para a tela de login
  //     updateRedirectToHome(false); // Reset redirectToLogin
  //     navigation.navigate('Login');
  //   }
  // }, [redirectToHome, navigation, updateRedirectToHome]);
